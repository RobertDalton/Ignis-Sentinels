...
#TODO: include Twitter API and DB search
with project_client:
    agent = project_client.agents.create_agent(
        model=model,
        name="Vulnerable-Zones-Agent",
        instructions="You will perform web search for vulnerable wildfire assets (Hospitals, communities, Routes)",
